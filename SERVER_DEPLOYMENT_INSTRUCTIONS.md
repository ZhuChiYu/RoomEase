...
| 服务 | 标准端口 | 实际映射端口 | 说明 |
|------|----------|--------------|------|
| Nginx HTTP | 80 | **8080** | Web访问入口 |
| Nginx HTTPS | 443 | **8443** | SSL访问入口 |
| API Gateway | 4000 | **4000** | 可直接访问 |
| PostgreSQL | 5432 | **5433** | 避免与test-postgres冲突 |
| Redis | 6379 | **6380** | 避免与test-redis冲突 |
| RabbitMQ | 5672 | **5673** | AMQP端口 |
| RabbitMQ管理 | 15672 | **15673** | 管理界面 |
| ClickHouse HTTP | 8123 | **8124** | HTTP接口 |
| ClickHouse Native | 9000 | **9003** | 原生协议 |
| MinIO Console | 9001 | **9004** | 控制台 |
| MinIO API | 9002 | **9005** | S3 API |
...
```
API文档: http://111.230.110.95:8080/docs
健康检查: http://111.230.110.95:8080/health
或直接访问: http://111.230.110.95:4000/health
Grafana监控: http://111.230.110.95:3001
RabbitMQ管理: http://111.230.110.95:15673
MinIO控制台: http://111.230.110.95:9004
```
...
export const API_CONFIG = {
  BASE_URL: isDev 
    ...
    : 'http://111.230.110.95:8080',      // 通过 Nginx (端口 8080)
    // : 'http://111.230.110.95:4000',   // 或直接连接 API Gateway
